...
export default function Article() {
    return (
        <>
            ...
            <div id="CartDrawer" className="drawer drawer--right drawer--has-fixed-footer" tabIndex={-1}>
                <div className="drawer__fixed-header">
                    <div className="drawer__header">
                        <div className="drawer__title">Your cart</div>
                        <div className="drawer__close">
                            <button type="button" className="icon-fallback-text drawer__close-button js-drawer-close">
                    ...
                    <div id="CartContainer" className="drawer__cart">
                        <form action="./cart" method="post" noValidate="" className="cart ajaxcart">
                                    ...
                                    <div className="ajaxcart__row" data-line={1}>
                                        <div className="grid">
                                            <div className="grid__item one-quarter">
                                                <a href="./product" className="ajaxcart__product-image">
                                            ...
                                            <div className="grid__item three-quarters">
                                                <div className="ajaxcart__product-name--wrapper">
                                                    <a href="./product" className="ajaxcart__product-name">
                                                ...
                                                <div className="grid--full display-table">
                                                    <div className="grid__item display-table-cell one-half">
                                                        <div className="ajaxcart__qty">
                                                            ...
                                                            <input type="text" name="updates[]" className="ajaxcart__qty-num"
                                                                defaultValue={1} min={0} data-line={1} aria-label="quantity"
                                                                pattern="[0-9]*" />
                                                            <button type="button"
                                                                className="ajaxcart__qty-adjust ajaxcart__qty--plus icon-fallback-text"
                                                                data-line={1} data-qty={2}
                                                ...
                                                <div className="grid--full display-table">
                                                    <div className="grid__item display-table-cell one-half">
                                                        <div className="ajaxcart__qty">
                                                            ...
                                                            <input type="text" name="updates[]" className="ajaxcart__qty-num"
                                                                defaultValue={1} min={0} data-line={2} aria-label="quantity"
                                                                pattern="[0-9]*" />
                                                            <button type="button"
                                                                className="ajaxcart__qty-adjust ajaxcart__qty--plus icon-fallback-text"
                                                                data-line={2} data-qty={2}
                                                                aria-label="Increase item quantity by one">
                                                                <span className="icon icon-plus" aria-hidden="true" />
                                                                <span className="fallback-text" aria-hidden="true">
                                                                    +
                                                ...
                                                <div className="grid--full display-table">
                                                    <div className="grid__item display-table-cell one-half">
                                                        <div className="ajaxcart__qty">
                                                            ...
                                                            <input type="text" name="updates[]" className="ajaxcart__qty-num"
                                                                defaultValue={1} min={0} data-line={3} aria-label="quantity"
                                                                pattern="[0-9]*" />
                                                            <button type="button"
                                                                className="ajaxcart__qty-adjust ajaxcart__qty--plus icon-fallback-text"
                                                                data-line={3} data-qty={2}
                                                                aria-label="Increase item quantity by one">
                                                                <span className="icon icon-plus" aria-hidden="true" />
                                                                <span className="fallback-text" aria-hidden="true">
                                                                    +
                                                ...
                                                <div className="grid--full display-table">
                                                    <div className="grid__item display-table-cell one-half">
                                                        <div className="ajaxcart__qty">
                                                            ...
                                                            <input type="text" name="updates[]" className="ajaxcart__qty-num"
                                                                defaultValue={1} min={0} data-line={4} aria-label="quantity"
                                                                pattern="[0-9]*" />
                                                            <button type="button"
                                                                className="ajaxcart__qty-adjust ajaxcart__qty--plus icon-fallback-text"
                                                                data-line={4} data-qty={2}
                                                                aria-label="Increase item quantity by one">
                                                                <span className="icon icon-plus" aria-hidden="true" />
                                                                <span className="fallback-text" aria-hidden="true">
                                                                    +
                            ...
                            <div className="ajaxcart__footer ajaxcart__footer--fixed">
                                ...
                                <a href="./cart" className="btn--secondary btn--full cart__checkout" style={{ marginBottom: 10 }}>
                                    Shopping Cart{" "}
                                    <span className="icon icon-arrow-right" aria-hidden="true" />
                                </a>
                                <button type="submit" className="btn--secondary btn--full cart__checkout" name="checkout">
                                    Check Out{" "}
                                    <span className="icon icon-arrow-right" aria-hidden="true" />
                                </button>
                            </div>
            ...
            <div id="PageContainer" className="is-moved-by-drawer">
                <header className="">
                    <div id="html-section-header" className="html-section">
                        ...
                        <div className="topheader small--hide">
                            <div className="wrapper">
                                <div className="left-area">
                                    <div className="site-nav__item nav-language medium-down--hide">
                                        <div className="switcher notranslate">
                                            <div className="selected lang-switcher">
                                                <a href="./">
                                                    <img src="./assets/images/en.png" height={16} width={16} alt="en" />{" "}
                                                    English
                                                </a>
                                            </div>
                                            <div className="option">
                                                <a href="./" title="English" className="lang-sub selected">
                                                    <img src="./assets/images/en.png" height={16} width={16} alt="en" />{" "}
                                                    English
                                                </a>
                                                <a href="./" title="French" className="lang-sub">
                                                    <img src="./assets/images/fr.png" height={16} width={16} alt="fr" />{" "}
                                                    French
                                                </a>
                                                <a href="./" title="German" className="lang-sub">
                                                    <img src="./assets/images/de.png" height={16} width={16} alt="de" />{" "}
                                                    German
                                                </a>
                                                <a href="./" title="Italian" className="lang-sub">
                                                    <img src="./assets/images/it.png" height={16} width={16} alt="it" />{" "}
                                                    Italian
                                                </a>
                                                <a href="./" title="Russian" className="lang-sub">
                                                    <img src="./assets/images/ru.png" height={16} width={16} alt="ru" />{" "}
                                                    Russian
                                                </a>
                                                <a href="./" title="Spanish" className="lang-sub">
                                                    <img src="./assets/images/es.png" height={16} width={16} alt="es" />{" "}
                                                    Spanish
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div className="site-nav__item nav-currency medium-down--hide">
                                        <div className="switcher notranslate">
                                            <div className="selected currency-switcher">
                                                <a href="./">
                                                    <img src="./assets/images/usd.png" height={16} width={16} alt="en" />{" "}
                                                    US Dollar
                                                </a>
                                            </div>
                                            <div className="option">
                                                <a href="./" title="English" className="curr-sub selected">
                                                    <img src="./assets/images/usd.png" height={16} width={16} alt="en" />{" "}
                                                    USD
                                                </a>
                                                <a href="./" title="French" className="curr-sub">
                                                    <img src="./assets/images/euro.png" height={16} width={16} alt="en" />{" "}
                                                    Euro
                                                </a>
                                                <a href="./" title="German" className="curr-sub">
                                                    <img src="./assets/images/pound.png" height={16} width={16} alt="en" />{" "}
                                                    Pound
                                                </a>
                                                <a href="./" title="Italian" className="curr-sub">
                                                    <img src="./assets/images/yen.png" height={16} width={16} alt="en" />{" "}
                                                    Yen
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div id="AppModal" className="mfp-hide" style={{ maxWidth: 500, margin: "0 auto" }}>
                                        ...
                                        <div className="ios-area">
                                            <div className="qrimg-android">
                                                <a href="#">
                                                    <img src="./assets/images/QR_Code_Megastore.png" alt="Image Column" />
                                                </a>
                                            </div>
                                    ...
                                    <div className="social-icons">
                                        ...
                                        <div id="SocialModal" className="mfp-hide" style={{ maxWidth: 500, margin: "0 auto" }}>
                                            <div className="inline-list social-icons">
                                                <a href="#" title="Twitter" className="icon-social twitter"
                                                    data-toggle="tooltip" data-placement="top">
                                                    <i className="fa fa-twitter" />
                                                </a>
                                                <a href="#" title="Facebook" className="icon-social facebook"
                                                    data-toggle="tooltip" data-placement="top">
                                                    <i className="fa fa-facebook" />
                                                </a>
                                                <a href="#" title="Google+" className="icon-social google" data-toggle="tooltip"
                                                    data-placement="top">
                                                    <i className="fa fa-google-plus" />
                                                </a>
                                                <a href="#" title="Pinterest" className="icon-social pinterest"
                                                    data-toggle="tooltip" data-placement="top">
                                                    <i className="fa fa-pinterest" />
                                                </a>
                                                <a href="#" title="Youtube" className="icon-social youtube"
                                                    data-toggle="tooltip" data-placement="top">
                                                    <i className="fa fa-youtube" />
                                                </a>
                                                <a href="#" title="Instagram" className="icon-social instagram"
                                                    data-toggle="tooltip" data-placement="top">
                                                    <i className="fa fa-instagram" />
                                                </a>
                                                <a href="#" title="translation missing: en.layout.footer.news"
                                                    className="icon-social atom" data-toggle="tooltip" data-placement="top">
                                                    <i className="fa fa-share-alt" />
                                                </a>
                                                <a href="#" title="Vimeo" className="icon-social vimeo" data-toggle="tooltip"
                                                    data-placement="top">
                                                    <i className="fa fa-vimeo" />
                                                </a>
                                                <a href="#" title="Tumblr" className="icon-social tumblr" data-toggle="tooltip"
                                                    data-placement="top">
                                ...
                                <div className="right-area">
                                    <ul>
                                        ...
                                        <li className="customer-link site-nav__item">
                                            <a className="site-nav__link site-nav__link--icon js-login-modal"
                                                data-mfp-src="#LoginModal">
                                                <i className="icon-customer" aria-hidden="true" />
                                                <span className="text">My Account</span>
                                            </a>
                                            <div id="LoginModal" className="mfp-hide" style={{
                                                maxWidth: 500, margin: "0 auto"
                                            }}>
                                                <div id="loginBox" className="loginLightbox">
                                                    <div id="lightboxlogin">
                                                        <form method="post" action="./account-login.html" id="customer_login"
                                                            acceptCharset="UTF-8">
                                                            ...
                                                            <div id="bodyBox">
                                                                <h3>Login</h3>
                                                                <label htmlFor="CustomerEmail" className="hidden-label">
                                                                    Email
                                                                </label>
                                                                <input type="email" name="customer[email]" id="CustomerEmail"
                                                                    className="input-full" placeholder="Email" />
                                                                <label htmlFor="CustomerPassword" className="hidden-label">
                                                                    Password
                                                                </label>
                                                                <input type="password" defaultValue="" name="customer[password]"
                                                                    id="CustomerPassword" className="input-full"
                                                                    placeholder="Password" />
                                                                <input type="submit" className="btn btn2 btn--full"
                                                    ...
                                                    <div id="recover-password" style={{ display: "none" }}>
                                                        ...
                                                        <form method="post" action="/account/recover" acceptCharset="UTF-8">
                                                            ...
                                                            <input type="email" defaultValue="" size={30} name="email"
                                                                id="recover-email" className="text" />
                                                            <div className="action_bottom">
                                                                <p>
                                                                    <input className="btn btn2" type="submit"
                                                                        defaultValue="Submit" />
                                                                </p>
                                                                <p>
                                                                    <a className="btn--secondary back btn--full" href="#"
                                                        ...
                                                        <div className="form-vertical">
                                                            <form method="post" action="/account" id="create_customer"
                                                                ...
                                                                <input type="text" name="customer[first_name]" id="FirstName"
                                                                    className="input-full" placeholder="First Name" />
                                                                <label htmlFor="LastName" className="hidden-label">
                                                                    Last Name
                                                                </label>
                                                                <input type="text" name="customer[last_name]" id="LastName"
                                                                    className="input-full" placeholder="Last Name" />
                                                                <label htmlFor="Email" className="hidden-label">
                                                                    Email
                                                                </label>
                                                                <input type="email" name="customer[email]" id="Email2"
                                                                    className="input-full" placeholder="Email" />
                                                                <label htmlFor="CreatePassword" className="hidden-label">
                                                                    Password
                                                                </label>
                                                                <input type="password" name="customer[password]"
                                                                    id="CreatePassword" className="input-full"
                                                                    placeholder="Password" />
                                                                <p>
                                                                ...
                                                                <p>
                                                                    <span>
                                                                        <a className="btn--secondary btn--full" href="#"
                                                                            onclick="hideRecoverPasswordForm();return false;">
                                                                            Cancel
                                                                        </a>
                                                                    </span>
                                        ...
                                        <li className="site-nav__item compare_link">
                                            <a href="./pagecompare">
                                                <i className="fa fa-refresh" aria-hidden="true" title="Compare" />
                                            </a>
                                        </li>
                                        <li className="site-nav__item wishlist_link">
                                            <a href="./pagewishlist">
                                                <i className="fa fa-heart-o" aria-hidden="true" title="Wishlist" />
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div data-section-id="header" data-section-type="header-section" className="header-section">
                            <div className="header-wrapper header-wrapper--over-hero">
                                <div className="wrapper main-header-wrapper">
                                    <div className="grid--full grid--table">
                                        {/* Mobile Button */}
                                        <div
                                            className="grid__item large--hide medium-down--one-quarter small--one-quarter nav-mobile">
                                            <div>
                                                <button type="button"
                                        ...
                                        {/* Mobile Cart */}
                                        <div
                                            className="grid__item large--hide medium-down--one-quarter small--one-quarter cart-mobile">
                                            <div className="text-right">
                                                <a href="./cart" className="site-nav__link cart-link js-drawer-open-right"
                                        ...
                                        <div className="mobileNav-search large--hide medium-down--one-whole small--one-whole">
                                            <form action="./search" method="get"
                                                className="input-group search-bar search-bar--drawer" role="search" style={{
                                                    position: "relative"
                                                }}>
                                                <input type="search" name="q" defaultValue="" placeholder="Search something"
                                                    className="input-group-field" aria-label="Search something"
                                                    autoComplete="off" />
                                                <span className="input-group-btn">
                                                    <button type="submit" className="btn--secondary icon-fallback-text">
                                        ...
                                        <div className="grid__item large--show medium-down--hide smal--hide">
                                            <div className="wrapper-middle">
                                                ...
                                                <div className="grid__item large--three-tenths logo-wrapper">
                                                    <a href="./" itemProp="url" className="site-header__logo-image">
                                                        <img src="./assets/images/logo.png" alt="" />
                                                    </a>
                                                </div>
                                                {/* Search Box */}
                                                <div className="grid__item header-search large--five-tenths small--hide">
                                                    <div className="header-search-inner">
                                                        <form action="./search" method="get"
                                                            className="input-group search-bar " role="search" style={{
                                                                position: "relative"
                                                            }}>
                                                            <input type="hidden" name="type" defaultValue="product" />
                                                            <input type="search" name="q" defaultValue=""
                                                                placeholder="Search something" className="input-group-field"
                        ...
                        <div className="wrapper wrapper-allcoll">
                            <div className="innerpages-allcoll small--hide">
                                <div className="wrap_allcoll">
                                    <div id="html-section-home-vertical-menu"
                                        ...
                                        <div className="allcollections-content have-icon">
                                            <ul className="sdcollections-list">
                                                <li className="site-nav__item site-nav--has-dropdown dropdown megamenu-vertical megacol-3 dropdown-long"
                                                    aria-haspopup="true">
                                                    <p className="site-nav__link">
                                                        ...
                                                        <span className="fa fa-caret-right click_arrow" aria-hidden="true" />
                                                    </p>
                                                ...
                                                <li className="site-nav__item site-nav--has-dropdown dropdown megamenu-vertical megacol-3"
                                                    aria-haspopup="true">
                                                    <p className="site-nav__link">
                                                        <span className="site-nav__icon icon-3">
                                                            <img src="./assets/images/mobile-phone-popular-model-nexus-5.png"
                                                                alt="" />
                                                        </span>
                                                        <a href="./collection" className="site-nav__text">
                            ...
                            <div id="html-section-navigation" className="html-section">
                                <div data-section-id="navigation" data-section-type="horizontal-menu-section">
                                    <div className="grid--full grid--table">
                                        <div className="horizontal-menu desktop-menu medium-down--hide" style={{}}>
                                            <ul className="site-nav site-nav--init" id="AccessibleNav">
                                                <li className="site-nav__item site-nav__expanded-item  active" data-url="/">
                                                    <a href="./" className="site-nav__link">
                                                        <span>Home</span>
                                                    </a>
                                                </li>
                                                <li className="site-nav__item site-nav__expanded-item site-nav--has-dropdown dropdown navigation desknav mega-menu"
                                                    aria-haspopup="true">
                                                    <a href="./collection" className="site-nav__link">
                                                        <span>Collections</span>
                                                        <span className="icon icon-arrow-down" aria-hidden="true" />
                                                    </a>
                                                    <ul className="site-nav__dropdown column-5" style={{ maxWidth: 1220 }}>
                                                        <li
                                                            className="site-nav__item column-linklist grid__item small--one-whole medium-up--one-third one-fifth">
                                                            <ul>
                                                ...
                                                <li className="site-nav__item site-nav__expanded-item site-nav--has-dropdown dropdown navigation desknav mega-menu"
                                                    ...
                                                    <ul className="site-nav__dropdown column-5" style={{ maxWidth: 1220 }}>
                                                        <li
                                                            className="mobile-nav__item column-product grid__item small--one-whole medium-up--one-third one-fifth">
                                                            <div className="grid-view-item">
                                                                <div className="grid-normal-display">
                                                                    ...
                                                                    <div className="quickbuy">
                                                                        <div
                                                                            className="product-ajax-quickbuy in-stock hidden-xs hidden-sm">
                                                                            <div className="effect-ajax-cart">
                                                                                <form action="./product" method="post"
                                                                                    ...
                                                                                    <input type="hidden" name="quantity"
                                                                                        defaultValue={1} />
                                                                                    <div
                                                                                        className="product-single__add-to-cart">
                                                                ...
                                                                <div className="group-information style-">
                                                                    ...
                                                                    <div className="price-and-ship">
                                                                        <div
                                                                            className="grid-view-item__meta grid__item large--three-quarters">
                                                                            <s className="product-price__price">
                                                                                <span className="money">$24.99 USD</span>
                                                                            </s>
                                                                            <span
                                                                                className="product-price__price product-price__sale">
                                                                        ...
                                                                        <div className="shipcode grid__item large--one-quarter">
                                                                            <img src="./assets/images/freeshipicon.svg"
                                                                    ...
                                                                    <div className="group-functions">
                                                                        ...
                                                                        <ul className="action-button grid__item one-half">
                                                                            <li className="button-wishlist">
                                                                                <a className="wish-list wlc wl-1552981229660"
                                                                            ...
                                                                            <li className="button-compare">
                                                                                <a className="wish-list cmc cm-1552981229660"
                                                            ...
                                                            <div className="grid-view-item">
                                                                ...
                                                                <div className="group-information style-">
                                                                    ...
                                                                    <div className="group-functions">
                                                                        ...
                                                                        <ul className="action-button grid__item one-half">
                                                                            <li className="button-wishlist">
                                                                                <a className="wish-list wlc wl-1559895399994"
                                                                            ...
                                                                            <li className="button-compare">
                                                                                <a className="wish-list cmc cm-1559895399994"
                                                                    ...
                                                                    <div className="group-functions">
                                                                        <div className="rating-star grid__item one-half">
                                                                            <span className="spr-badge"
                                                                                id="spr_badge_1419620057177" data-rating={0.0}>
                                                                                <span
                                                                                    className="spr-starrating spr-badge-starrating">
                                                                                    <i className="spr-icon spr-icon-star" />
                                                                                    <i className="spr-icon spr-icon-star" />
                                                                        ...
                                                                        <ul className="action-button grid__item one-half">
                                                                            <li className="button-wishlist">
                                                                                <a className="wish-list wlc wl-1554438559100"
                                                                            ...
                                                                            <li className="button-compare">
                                                                                <a className="wish-list cmc cm-1554438559100"
                                                            ...
                                                            <div className="grid-view-item">
                                                                ...
                                                                <div className="group-information style-">
                                                                    ...
                                                                    <div className="group-functions">
                                                                        ...
                                                                        <ul className="action-button grid__item one-half">
                                                                            <li className="button-wishlist">
                                                                                <a className="wish-list wlc wl-1559895406376"
                                                                            ...
                                                                            <li className="button-compare">
                                                                                <a className="wish-list cmc cm-1559895406376"
                                                            ...
                                                            <div className="grid-view-item">
                                                                ...
                                                                <div className="group-information style-">
                                                                    ...
                                                                    <div className="group-functions">
                                                                        ...
                                                                        <ul className="action-button grid__item one-half">
                                                                            <li className="button-wishlist">
                                                                                <a className="wish-list wlc wl-1559895404763"
                                                                            ...
                                                                            <li className="button-compare">
                                                                                <a className="wish-list cmc cm-1559895404763"
                                                ...
                                                <li className="site-nav__item site-nav__expanded-item site-nav--has-dropdown dropdown navigation desknav mega-menu"
                                                    aria-haspopup="true" data-url="/collections/all">
                                                    <a href="./collection" className="site-nav__link">
                                                    ...
                                                    <ul className="site-nav__dropdown column-5" style={{ maxWidth: 1220 }}>
                                                        <li
                                                            className="site-nav__item column-text grid__item small--one-whole medium-up--one-third one-fifth">
                                                        ...
                                                        <li
                                                            className="site-nav__item column-image grid__item small--one-whole medium-up--one-third one-fifth">
                                                            <a href="./collection">
                                                ...
                                                <li className="site-nav__item site-nav__expanded-item site-nav--has-dropdown dropdown navigation desknav dropdown-menu"
                                                    aria-haspopup="true" data-url="/collections/all">
                                                    <a href="./collection" className="site-nav__link">
                                                        <span>Pages</span>
                                                        <span className="icon icon-arrow-down" aria-hidden="true" />
                                                    </a>
                                                    <ul className="site-nav__dropdown column-1" style={{ maxWidth: 300 }}>
                                                        <li className="site-nav__item site-nav__expanded-item site-nav--has-dropdown  dropdown navigation desknav"
                                                            aria-haspopup="true">
                                                            <a href="./pageabout" className="site-nav__link">
                                                                <span>About Us</span>
                                                                <span className="icon icon-arrow-down" aria-hidden="true" />
                                                            </a>
                                                        ...
                                                        <li className="site-nav__item site-nav__expanded-item">
                                                            <a href="./pagewishlist" className="site-nav__link">
                                                                <span>Wishlist</span>
                                                            </a>
                                                        </li>
                                                    </ul>
                                            ...
                                            <div id="MobileNav" className="mobileNav-left">
                                                ...
                                                <div className="mobileNav-menu">
                                                    <ul className="mobileNav-nav">
                                                        ...
                                                        <li className="mobile-nav__item mobile-nav__item-menulv1 mega-menu"
                                                            data-father="none" data-url="/collections/all">
                                                            <div className="mobile-nav__has-sublist">
                                                                <a href="./collection" className="mobile-nav__link">
                                                                    Collections
                                                                </a>
                                                                <div className="mobile-nav__toggle">
                                                                    <button type="button"
                                                                        ...
                                                                        <span
                                                                            className="icon-fallback-text mobile-nav__toggle-open">
                                                                        ...
                                                                        <span
                                                                            className="icon-fallback-text mobile-nav__toggle-close">
                                                            ...
                                                            <ul
                                                                className="mobile-nav__sublist mobile-nav__sublist-menulv1 megamenu__dropdown megamenu_1">
                                                                <li
                                                                    className="mobile-nav__item column-linklist grid__item small--one-whole medium-up--one-third one-fifth">
                                                                    <ul>
                                                                        <li className="site-nav__item site-nav__item-title">
                                                                            Fashion Collection
                                                                        </li>
                                                                ...
                                                                <li
                                                                    ...
                                                                    <div className="grid-view-item">
                                                                        ...
                                                                        <div className="group-information style-">
                                                                            ...
                                                                            <div className="price-and-ship">
                                                                                <div
                                                                                    ...
                                                                                    <span
                                                                                        ...
                                                                                        <span
                                                                                            className="product-price__sale-label">
                                                                                            On Sale
                                                                                        </span>
                                                                                    </span>
                                                                                </div>
                                                                                <div
                                                                                    className="shipcode grid__item large--one-quarter">
                                                                                    <img src="./assets/images/freeshipicon.svg"
                                                                                        alt="free shipping icon" />
                                                                                </div>
                                                                            </div>
                                                                            <div className="group-functions">
                                                                                <div
                                                                                    className="rating-star grid__item one-half">
                                                                                    <span className="spr-badge"
                                                                                        data-rating={5.0}>
                                                                                        <span
                                                                                            className="spr-starrating spr-badge-starrating">
                                                                                ...
                                                                                <ul
                                                                                    className="action-button grid__item one-half">
                                                                                    <li className="button-wishlist">
                                                                                        <a className="wish-list wlc wl-1559895403066"
                                                                                    ...
                                                                                    <li className="button-compare">
                                                                                        <a className="wish-list cmc cm-1559895403066"
                                                                        ...
                                                                        <div className="group-information style-">
                                                                            ...
                                                                            <div className="group-functions">
                                                                                ...
                                                                                <ul
                                                                                    className="action-button grid__item one-half">
                                                                                    <li className="button-wishlist">
                                                                                        <a className="wish-list wlc wl-1559895398140"
                                                                                    ...
                                                                                    <li className="button-compare">
                                                                                        <a className="wish-list cmc cm-1559895398140"
                                                                        ...
                                                                        <div className="group-information style-">
                                                                            ...
                                                                            <div className="group-functions">
                                                                                ...
                                                                                <ul
                                                                                    className="action-button grid__item one-half">
                                                                                    <li className="button-wishlist">
                                                                                        <a className="wish-list wlc wl-1559895396466"
                                                                                    ...
                                                                                    <li className="button-compare">
                                                                                        <a className="wish-list cmc cm-1559895396466"
                                                                        ...
                                                                        <div className="group-information style-">
                                                                            ...
                                                                            <div className="group-functions">
                                                                                ...
                                                                                <ul
                                                                                    className="action-button grid__item one-half">
                                                                                    <li className="button-wishlist">
                                                                                        <a className="wish-list wlc wl-1559895394200"
                                                                                    ...
                                                                                    <li className="button-compare">
                                                                                        <a className="wish-list cmc cm-1559895394200"
                                                                        ...
                                                                        <div className="group-information style-">
                                                                            ...
                                                                            <div className="group-functions">
                                                                                ...
                                                                                <ul
                                                                                    className="action-button grid__item one-half">
                                                                                    <li className="button-wishlist">
                                                                                        <a className="wish-list wlc wl-1559895387337"
                                                                                    ...
                                                                                    <li className="button-compare">
                                                                                        <a className="wish-list cmc cm-1559895387337"
                                                        ...
                                                        <li className="mobile-nav__item mobile-nav__item-menulv1 mega-menu"
                                                            ...
                                                            <ul
                                                                className="mobile-nav__sublist mobile-nav__sublist-menulv1 megamenu__dropdown megamenu_1">
                                                                <li
                                                                    className="mobile-nav__item column-text grid__item small--one-whole medium-up--one-third one-fifth">
                                                                ...
                                                                <li
                                                                    className="mobile-nav__item column-image grid__item small--one-whole medium-up--one-third one-fifth">
                                                                    <a href="./collection">
                                                                        <img src="./assets/images/mega-img1.png" alt="" />
                                                                    </a>
                                                                </li>
                                                        ...
                                                        <li className="mobile-nav__item mobile-nav__item-menulv1 dropdown-menu"
                                                            data-father="none" data-url="/collections/all">
                                                            <div className="mobile-nav__has-sublist">
                                                                <a href="./pageabout" className="mobile-nav__link">
                                                                    Pages
                                                                </a>
                                                                <div className="mobile-nav__toggle">
                                                                    <button type="button"
                                                            ...
                                                            <ul
                                                                ...
                                                                <li className="mobile-nav__item mobile-nav__item-menulv2">
                                                                    ...
                                                                    <ul
                                                                        className="mobile-nav__sublist mobile-nav__sublist-menulv2">
                                                                ...
                                                                <li className="mobile-nav__item">
                                                                    <a href="./page-faq.html" className="site-nav__link">
                                                                        <span>FAQ</span>
                                                                    </a>
                                                                </li>
                                                                <li className="mobile-nav__item">
                                                        ...
                                                        <li className="mobile-nav__item" data-url="/pages/contact-us">
                                                            <a href="./pagecontact" className="site-nav__link">
                                                                <span>Contact Us</span>
                                                            </a>
                                                        </li>
                ...
                <main className="main-content">
                    <div className="mobile-allcoll small--show large--hide">
                        <div className="wrap_allcoll grid__item small--one-whole">
                            <div id="html-section-home-vertical-menu" className="html-section index-section revolution-slider">
                                <div className="allcollections-title">
                                    <span className="title">Categories</span>
                                    <div className="icon-main-toggle navbar-toggle">
                                        <i className="fa fa-caret-down" aria-hidden="true" />
                    ...
                    <div id="html-section-cart-template" className="html-section">
                        <div id="CartSection">
                            ...
                            <div className="wrapper">
                                <div className="grid">
                                    <article className="grid__item article" itemScope="" itemType="http://schema.org/Article">
                                        <div className="grid">
                                            <div className="grid__item">
                                                <p className="article-top">
                                                    <span className="author">By aztheme-6 Admin</span>
                                                    <span className="date">
                                                        <time dateTime="2018-05-03">May 03, 2018</time>
                                                    </span>
                                                    <span className="comment">0 comments</span>
                                                </p>
                                                ...
                                                <div className="article-content" itemProp="articleBody">
                                                    ...
                                                    <p>
                                                        You're up to date on everything you need to know before
                                                        buying a phone, and now the time has come to actually
                                                        dig out your wallet and go for it. There are tons of
                                                        great phones that will fit your exact size, price and
                                                        carrier needs, but if you're looking for a shortcut,
                                                        allow me to present to you with my top picks, plus one
                                                        honorable mention. Happy shopping.
                                                    </p>
                                                    <ol>
                                                ...
                                                <div className="social-sharing clean">
                                                    <a target="_blank" href="//www.facebook.com/sharer.php?u=#"
                                                        className="share-facebook" title="Share on Facebook">
                                                    ...
                                                    <a target="_blank" href="//twitter.com/share?text=#url=#"
                                                        className="share-twitter" title="Tweet on Twitter">
                                                    ...
                                                    <a target="_blank"
                                                        ...
                                                        className="share-pinterest" title="Pin on Pinterest">
                                ...
                                <div className="text-right">
                                    <a href="./blog" className="return-link">
                                        ← Back to News
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div className="newsletter-social-block grid__item two-fifths">
                                        <div className="newsletter-area">
                                            ...
                                            <div className="action">
                                                <form method="post" action="#" id="contact_form" acceptCharset="UTF-8"
                                                    ...
                                                    <div className="newsletter-box input-group">
                                                        ...
                                                        <input type="email" name="contact[email]" id="Email"
                                                            className="input-group__field newsletter__input" defaultValue=""
                                            ...
                                            <div className="social">
                                                <ul className="socialLinks socialLinks--alt">
                                                    <li className="socialLinks-item">
                                                        <a href="./collection" title="" className="icon-social facebook">
                                                            <i className="fa fa-facebook" />
                                                        </a>
                                                    </li>
                                                    <li className="socialLinks-item">
                                                        <a href="./collection" title="" className="icon-social twitter">
                                                            <i className="fa fa-twitter" />
                                                        </a>
                                                    </li>
                                                    <li className="socialLinks-item">
                                                    ...
                                                    <li className="socialLinks-item">
                                                        <a href="./collection" title="" className="icon-social pinterest">
                                                            <i className="fa fa-pinterest" />
                                                        </a>
                                                    </li>
                                                    <li className="socialLinks-item">
                                                        <a href="./collection" title="" className="icon-social instagram">
                                                            <i className="fa fa-instagram" />
                                                        </a>
                                                    </li>
                                                </ul>
                                        ...
                                        <ul className="payment-icons list--inline">
                                            <li className="payment-icon">
                                                <svg aria-hidden="true" focusable="false" role="presentation"
                                                    className="icon icon-visa" viewBox="0 0 27 20">
                                                    <path fill="#444"
                                            ...
                                            <li className="payment-icon">
                                                <svg aria-hidden="true" focusable="false" role="presentation"
                                                    className="icon icon--wide icon-master" viewBox="0 0 23 15">
                                                    <path
                                                        ...
                                                        fill="#444" fillRule="evenodd" />
                                                </svg>
                                            </li>
                                            <li className="payment-icon">
                                                <svg aria-hidden="true" focusable="false" role="presentation"
                                                    className="icon icon-american_express" viewBox="0 0 20 20">
                                                    <path fill="#444"
                                            ...
                                            <li className="payment-icon">
                                                <svg aria-hidden="true" focusable="false" role="presentation"
                                                    className="icon icon--wide icon-paypal" viewBox="0 0 36 20">
                                                    <path fill="#444"
                                            ...
                                            <li className="payment-icon">
                                                <svg aria-hidden="true" focusable="false" role="presentation"
                                                    className="icon icon-diners_club" viewBox="0 0 17 20">
                                                    <path fill="#444"
                                            ...
                                            <li className="payment-icon">
                                                <svg aria-hidden="true" focusable="false" role="presentation"
                                                    className="icon icon--wide icon-discover" viewBox="0 0 52 20">
                                                    <path fill="#444"
