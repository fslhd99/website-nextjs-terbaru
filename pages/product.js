    ...
    <>
      ...
      <div id="PageContainer" className="is-moved-by-drawer">
        ...
        <main className="main-content">
          ...
          <div id="html-section-product-horizontal" className="html-section">
            <header className="section-header wrapper-breadcrumb">
              <div className="wrapper">
                ...
                >
                  ...
                  <a href="/collections/flash-sale" title="">
                    Flash Sale
                  </a>
                  <span aria-hidden="true">
                    <i className="fa fa-angle-right" aria-hidden="true" />
            ...
            <div
              className="product-horizontal-gallery"
              itemScope=""
              itemType="http://schema.org/Product"
              id="ProductSection"
              data-section-id="product-horizontal"
            ...
            >
              <div className="wrapper">
                <div itemScope="" itemType="http://schema.org/Product">
                  ...
                  <div className="next-prev-products">
                    <div className="prev-product2">
                      <a
                        href="./collection"
                        title="Consequuntur magni dolores"
                      >
                    ...
                    <div className="next-product2">
                      <a href="./collection" title="Raesent Scelerisque Dan">
                        <span className="img">
                          <img src="./assets/images/product7.png" alt="" />
                        </span>
                        <span className="icon">
                  ...
                  <div className="grid product-single">
                    <div className="grid__item large--one-half text-center">
                      <div
                        className="product-single__photos elevatezoom"
                        id="ProductPhoto"
                      >
                        <img
                          ...
                          alt="Reprehenderit qui in ea"
                          id="ProductPhotoImg"
                          data-image-id={3885204537433}
                          data-zoom-image="./assets/images/detail1.png"
                        />
                      </div>
                      <div className="product-single__thumbnails-grid">
                        <ul
                          className="product-single__thumbnails"
                          id="ProductThumbs"
                        >
                          <li className="thumb__element">
                            <a
                              href="./assets/images/detail1.png"
                          ...
                          <li className="thumb__element">
                            <a
                              href="./assets/images/detail2.png"
                              className="product-single__thumbnail"
                            >
                              <img
                          ...
                          <li className="thumb__element">
                            <a
                              href="./assets/images/detail3.png"
                              className="product-single__thumbnail"
                            >
                              <img
                          ...
                          <li className="thumb__element">
                            <a
                              href="./assets/images/detail4.png"
                              className="product-single__thumbnail"
                            >
                              <img
                          ...
                          <li className="thumb__element">
                            <a
                              href="./assets/images/detail5.png"
                              className="product-single__thumbnail"
                            >
                              <img
                          ...
                          <li className="thumb__element">
                            <a
                              href="./assets/images/detail6.png"
                              className="product-single__thumbnail"
                            >
                              <img
                          ...
                          <li className="thumb__element">
                            <a
                              href="./assets/images/detail7.png"
                              className="product-single__thumbnail"
                            >
                              <img
                                src="./assets/images/detail7.png"
                                alt="Reprehenderit qui in ea"
                              />
                            </a>
                          </li>
                          <li className="thumb__element">
                            <a
                              href="./assets/images/detail8.png"
                              className="product-single__thumbnail"
                            >
                              <img
                                src="./assets/images/detail8.png"
                                alt="Reprehenderit qui in ea"
                              />
                            </a>
                          </li>
                    ...
                    <div className="grid__item product-single__meta--wrapper large--one-half">
                      <div className="product-single__meta">
                        ...
                        >
                          <h3>Reprehenderit qui in ea</h3>
                          <span className="rating">
                            <span
                              className="spr-badge"
                              id="spr_badge_1419644960857"
                              data-rating={0.0}
                            >
                              <span className="spr-starrating spr-badge-starrating">
                          ...
                          <div className="group-addditionaldata">
                            <div className="watching-order">
                              <div className="watching-area">
                                <div className="watching-icon" />
                                <div
                                  className="watching-count"
                                  data-watchingmin={100}
                                  data-watchingmax={300}
                                >
                                  269
                                </div>
                            ...
                            <div className="qty-bar">
                              <span
                                className="order-process process"
                                style={{ width: "78.9474%" }}
                              />
                              <div className="order-text">
                                <span
                          ...
                          <div className="price_wrapper">
                            <span id="PriceA11y" className="visually-hidden">
                              Regular price
                            </span>
                            <span className="product-single__price--wrapper">
                              <span
                                id="ComparePrice"
                                className="product-single__price--compare-at"
                              >
                                <span className="money">$30.00 USD</span>
                              </span>
                            </span>
                            <span id="ComparePriceA11y" className="visually-hidden">
                              Sale price
                            </span>
                            <span
                              id="ProductPrice"
                              className="product-single__price on-sale"
                              itemProp="price"
                              content={25.0}
                            >
                              <span className="money">$25.00 USD</span>
                            </span>
                            <div className="product-salelabel ">
                              <span
                                className="salelabel-area"
                                style={{
                                  color: "#ff5722",
                                  backgroundColor: "#ffd839"
                                }}
                              ...
                              <span className="salelabel-days">6 days left</span>
                            </div>
                          </div>
                          <div className="sku">
                            <strong>SKU: </strong> J525RTA
                          </div>
                          <div className="collshow">
                            <strong>Category:</strong>
                            <a href="./collection">All Products</a>,
                            <a href="./collection">Flash Sale</a>,
                            <a href="./collection">Jewelry</a>
                          </div>
                          <div className="tags">
                            <strong>Tags:</strong>
                            <a href="./collection">jewelry</a>,
                            <a href="./collection">voluptate</a>
                          </div>
                          ...
                          <form
                            ...
                            method="post"
                            encType="multipart/form-data"
                            className="product-single__form AddToCartForm"
                            id=""
                          >
                            <div className="radio-wrapper js product-form__item radio-mode ">
                              <label
                                className="single-option-radio__label"
                                htmlFor="ProductSelect-option-0"
                              >
                                Title
                              </label>
                              <fieldset
                                className="single-option-radio"
                                name="title"
                              ...
                              >
                                <input
                                  ...
                                  defaultValue="Lithograph"
                                  data-index="option1"
                                  name="title"
                                  className="single-option-selector__radio"
                                  id="ProductSelect-option-title-Lithograph"
                                />
                                <label htmlFor="ProductSelect-option-title-Lithograph">
                                  Lithograph
                                </label>
                                <input
                                  type="radio"
                                  ...
                                  name="title"
                                  className="single-option-selector__radio"
                                  id="ProductSelect-option-title-Small"
                                />
                                <label htmlFor="ProductSelect-option-title-Small">
                                  Small
                                </label>
                                <input
                                  type="radio"
                                  ...
                                  name="title"
                                  className="single-option-selector__radio"
                                  id="ProductSelect-option-title-Medium"
                                />
                                <label htmlFor="ProductSelect-option-title-Medium">
                                  Medium
                                </label>
                              </fieldset>
                            </div>
                            <div className="radio-wrapper js product-form__item radio-mode color-option colormode-color">
                              <label
                                className="single-option-radio__label"
                                htmlFor="ProductSelect-option-1"
                              >
                                Color
                              </label>
                              <fieldset
                              ...
                              >
                                ...
                                />
                                <label
                                  htmlFor="ProductSelect-option-color-Green"
                                ...
                                />
                                <label
                                  htmlFor="ProductSelect-option-color-Red"
                                ...
                                />
                                <label
                                  htmlFor="ProductSelect-option-color-Blue"
                                ...
                                />
                                <label
                                  htmlFor="ProductSelect-option-color-Yellow"
                                ...
                                />
                                <label
                                  htmlFor="ProductSelect-option-color-White"
                            ...
                            >
                              <option
                                selected="selected"
                                data-sku="J525RTA"
                                value={12874945822809}
                              >
                                Lithograph / Green - $25.00 USD
                              </option>
                              <option data-sku="J525RTA" value={12874945855577}>
                                Small / Red - $19.99 USD
                              </option>
                              <option data-sku="J525RTA" value={12874945888345}>
                                Medium / Red - $19.99 USD
                              </option>
                              <option data-sku="J525RTA" value={12874945921113}>
                                Lithograph / Blue - $25.00 USD
                              </option>
                              <option data-sku="J525RTA" value={12874945953881}>
                                Lithograph / Red - $25.00 USD
                              </option>
                              <option data-sku="J525RTA" value={12874945986649}>
                                Lithograph / Yellow - $25.00 USD
                              </option>
                              <option data-sku="J525RTA" value={12874946019417}>
                                Lithograph / White - $25.00 USD
                              </option>
                              <option data-sku="J525RTA" value={12874946052185}>
                                Small / Yellow - $19.99 USD
                              </option>
                              <option data-sku="J525RTA" value={12874946084953}>
                                Small / White - $19.99 USD
                              </option>
                              <option data-sku="J525RTA" value={12874946117721}>
                                Small / Green - $19.99 USD
                              </option>
                              <option data-sku="J525RTA" value={12874946150489}>
                                Medium / Green - $19.99 USD
                              </option>
                              <option data-sku="J525RTA" value={12874946183257}>
                                Medium / Blue - $19.99 USD
                              </option>
                            </select>
                            <div className="product-single__quantity">
                              <label
                                htmlFor="Quantity"
                                className="product-single__quantity-label js-quantity-selector"
                              >
                                Quantity
                              </label>
                            ...
                            <div className="group-button">
                              <div className="product-single__buynow">
                                <div
                                  className="btn Buynow"
                                  title="Add and Go to Checkout directly!"
                                >
                          ...
                          <div className="discount-code">
                            <div className="block-element">
                              ...
                              <div className="element-content">
                                <div className="code-cost">30% off</div>
                                <div className="code-code">2YVFT37F7B77</div>
                              </div>
                            </div>
                            <div className="block-element">
                              <div className="element-text">Weekly Coupon</div>
                              <div className="element-content">
                                <div className="code-cost">10% off</div>
                                <div className="code-code">J525RTJQV5VB</div>
                              </div>
                            </div>
                            <div className="block-element">
                              <div className="element-text">Shipping</div>
                              <div className="element-content">
                                <div className="code-cost">Free</div>
                                <div className="code-code">ZK1QZDBG9NVS</div>
                              </div>
                            </div>
                          </div>
                          <div className="returnpolicy">
                            <div className="block-element">
                              <div className="element-text">Return Policy</div>
                              <div className="element-content">
                                <div className="text">
                                  Returns accepted if product not as described,
                                  buyer pays return shipping fee; or keep the
                                  product &amp; agree refund with seller.
                                  <a href="pages/contact-us">View details</a>
                                </div>
                              </div>
                            </div>
                            <div className="block-element">
                              <div className="element-text">Seller Guarantees:</div>
                              <div className="element-content">
                                <div className="text">
                                  On-time Delivery
                                  <span>25 days</span>
                          ...
                          <div className="payment">
                            <div className="block-element">
                              <div className="element-text">Payment:</div>
                              <div className="element-content">
                          ...
                          <div className="buyerprotection">
                            <div className="block-element">
                              <div className="element-content">
                                ...
                                <div className="buyer-text1">
                                  <i
                                    className="fa fa-check-square-o"
                                    aria-hidden="true"
                                  />
                                  <strong>Full Refund</strong> if you don't receive
                                  your order.
                                </div>
                                <div className="buyer-text2">
                                  <i
                                    className="fa fa-check-square-o"
                                    aria-hidden="true"
                                  />
                    ...
                    <div className="text-right button-backtocol">
                      <a href="/collections/flash-sale" className="return-link">
                        ← Back to Flash Sale
                      </a>
                    </div>
                    <div className="grid grid__item product-information">
                      <div id="tabs-information">
                        <ul className="nav nav-tabs tabs-left sideways">
                          <li className="description">
                            <a href="#desc" data-toggle="tab" className="active">
                              Description
                            </a>
                          </li>
                          <li className="warranty">
                          ...
                          <li className="reviews">
                            <a href="#customerreview" data-toggle="tab">
                              Customer Review
                            </a>
                          </li>
                        </ul>
                        <div className="tab-panel active" id="desc">
                          <p style={{ textAlign: "center" }}>
                            <img src="./assets/images/desc1.png" />
                            <img src="./assets/images/desc2.png" />
                            <img src="./assets/images/desc3.png" />
                            <img src="./assets/images/desc4.png" />
                            <img src="./assets/images/desc5.png" />
                            <img src="./assets/images/desc6.png" />
                            <img src="./assets/images/desc7.png" />
                          </p>
                        </div>
                        <div className="tab-panel fade " id="size">
                          <h2>Warranty Information</h2>
                          <p>
                            LIMITED WARRANTIES
                            <br />
                            Limited Warranties are non-transferable. The following
                            Limited Warranties are given to the original retail
                            purchaser of the following Ashley Furniture Industries,
                            Inc.Products:
                          </p>
                          <p>
                            ...
                            <br /> A Limited Lifetime Warranty applies to all frames
                            used in sofas, couches, love seats, upholstered chairs,
                            ottomans, sectionals, and sleepers. Ashley Furniture
                            Industries,Inc. warrants these components to you, the
                            original retail purchaser, to be free from material
                            manufacturing defects.
                          </p>
                        </div>
                        <div className="tab-panel fade " id="delivery">
                          <h2>Purchasing &amp; Delivery</h2> Before you make your
                          purchase, it’s helpful to know the measurements of the
                          area you plan to place the furniture. You should also
                          measure any doorways and hallways through which the
                          furniture will pass to get to its final destination.
                          <br />
                          <h5>Picking up at the store</h5> Shop requires that all
                          products are properly inspected BEFORE you take it home to
                          insure there are no surprises. Our team is happy to open
                          all packages and will assist in the inspection process. We
                          will then reseal packages for safe transport. We encourage
                          all customers to bring furniture pads or blankets to
                          protect the items during transport as well as rope or tie
                          downs. Shop will not be responsible for damage that occurs
                          after leaving the store or during transit. It is the
                          purchaser’s responsibility to make sure the correct items
                          are picked up and in good condition.
                          <br />
                          <h5>Delivery</h5> Customers are able to pick the next
                          available delivery day that best fits their schedule.
                          However, to route stops as efficiently as possible, Shop
                          will provide the time frame. Customers will not be able to
                          choose a time. You will be notified in advance of your
                          scheduled time frame. Please make sure that a responsible
                          adult (18 years or older) will be home at that time.
                          <br /> In preparation for your delivery, please remove
                          existing furniture, pictures, mirrors, accessories, etc.
                          to prevent damages. Also insure that the area where you
                          would like your furniture placed is clear of any old
                          furniture and any other items that may obstruct the
                          passageway of the delivery team. Shop will deliver,
                          assemble, and set-up your new furniture purchase and
                          remove all packing materials from your home. Our delivery
                          crews are not permitted to move your existing furniture or
                          other household items. Delivery personnel will attempt to
                          deliver the purchased items in a safe and controlled
                          manner but will not attempt to place furniture if they
                          feel it will result in damage to the product or your home.
                          Delivery personnel are unable to remove doors, hoist
                          furniture or carry furniture up more than 3 flights of
                          stairs. An elevator must be available for deliveries to
                          the 4th floor and above.
                        </div>
                        <div className="tab-panel fade " id="payment">
                          <h2>Purchasing &amp; Delivery</h2> Before you make your
                          purchase, it’s helpful to know the measurements of the
                          area you plan to place the furniture. You should also
                          measure any doorways and hallways through which the
                        ...
                        <div className="tab-panel fade " id="customerreview"></div>
                      </div>
                      <div id="product-additional-information">
                        <div className="related-products">
                          ...
                          <div className="grid-uniform">
                            <ul className="related-products-items related-slider">
