                ...
                <div className="grid">
                  <div className="grid__item">
                    <header className="section-header text-center sticky affix animated">
                      <h1 className="text-center">Your Compare</h1>
                        ...
                        <table className="compare-box">
                          <tbody>
                            ...
                            <tr className="compare-image">
                              <td className="compare0-image col0">Images</td>
                              <td className="compare1-image col1">
                                <a href="./product">
                                  <img src="./assets/images/product1.png" alt="" />
                                </a>
                              </td>
                              <td className="compare2-image col2">
                                <a href="./product">
                                  <img src="./assets/images/product2.png" alt="" />
                                </a>
                              </td>
                              <td className="compare3-image col3">
                                <a href="./product">
                                  <img src="./assets/images/product3.png" alt="" />
                                </a>
                              </td>
                            ...
                            <tr className="compare-name">
                              <td className="compare0-name col0">Name</td>
                              <td className="compare1-name col1">
                                <a href="/products/raesent-scelerisque-dan-2">
                                  Raesent Scelerisque Dan
                                </a>
                              </td>
                              <td className="compare2-name col2">
                                <a href="/products/cum-sociis-natoque-penatibus-et-magnis-6">
                                  Cum sociis natoque
                                </a>
                              </td>
                              <td className="compare3-name col3">
                                <a href="/products/corporis-suscipit-laboriosam">
                                  Corporis suscipit laboriosam
                                </a>
                              </td>
                            </tr>
                            <tr className="compare-price">
                              <td className="compare0-price col0">Price</td>
                              <td className="compare1-price col1">
                                <span
                                  className="price money"
                              ...
                              <td className="compare2-price col2">
                                <span
                                  className="price money"
                                  doubly-currency-usd={8000}
                                  doubly-currency="USD"
                                >
                                  $80.00 USD
                                </span>
                              ...
                              <td className="compare3-price col3">
                                <span
                                  className="price money"
                                  doubly-currency-usd={8900}
                                  doubly-currency="USD"
                            ...
                            <tr className="compare-vendor">
                              <td className="compare0-vendor col0">Vendor</td>
                              <td className="compare1-vendor col1">Acme</td>
                              <td className="compare2-vendor col2">Loremous</td>
                              <td className="compare3-vendor col3">ensuregold</td>
                            </tr>
                            <tr className="compare-type">
                              <td className="compare0-type col0">Type</td>
                              <td className="compare1-type col1">Jewelry</td>
                              <td className="compare2-type col2">Dress</td>
                              <td className="compare3-type col3">Funiture</td>
                            </tr>
                            <tr className="compare-variant">
                              <td className="compare0-variant col0">Variant</td>
                              <td className="compare1-variant col1">
                                <span>XS / Red</span>
                                <br />
                                <span>S / Red</span>
                                <br />
                              ...
                              <td className="compare2-variant col2">
                                <span>XS / Black</span>
                                <br />
                                <span>S / Black</span>
                                <br />
                              ...
                              <td className="compare3-variant col3" />
                            </tr>
                            <tr className="compare-available">
                              <td className="compare0-available col0">Available</td>
                              <td className="compare1-available col1">In Stock</td>
                              <td className="compare2-available col2">In Stock</td>
                              <td className="compare3-available col3">In Stock</td>
                            </tr>
                            <tr className="compare-remove">
                              <td className="compare0-remove col0">Remove</td>
                              <td
                                className="compare1-remove col1"
                                data-remove="col1"
                                data-compareid="raesent-scelerisque-dan-2"
                              >
                                <i className="fa fa-times" aria-hidden="true" />
                              </td>
                              <td
                                className="compare2-remove col2"
                                data-remove="col2"
                                data-compareid="cum-sociis-natoque-penatibus-et-magnis-6"
                              >
                                <i className="fa fa-times" aria-hidden="true" />
                              </td>
                              <td
                                className="compare3-remove col3"
                                data-remove="col3"
                                data-compareid="corporis-suscipit-laboriosam"
                              >
                                <i className="fa fa-times" aria-hidden="true" />
                              </td>
                            </tr>
                            <tr className="compare-detail">
                              <td className="compare0-detail col0">Detail</td>
                              <td className="compare1-detail col1">
                                <a href="/products/raesent-scelerisque-dan-2">
                                  Go Detail
                                </a>
                              </td>
                              <td className="compare2-detail col2">
                                <a href="/products/cum-sociis-natoque-penatibus-et-magnis-6">
                                  Go Detail
                                </a>
                              </td>
                              <td className="compare3-detail col3">
                                <a href="/products/corporis-suscipit-laboriosam">
                                  Go Detail
                                </a>
                              </td>
