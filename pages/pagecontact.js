                            ...
                            <div className="wrapper">
                                <div className="grid">
                                    <div className="grid__item contact-wrapper">
                                        ...
                                        />
                                        <div
                                            className="grid__item large--one-half"
                                            style={{ paddingLeft: 0 }}
                                        >
                                            <p>
                                            ...
                                            <ul className="contact-list">
                                                <li className="address">
                                                    <i className="fa fa-street-view" /> Address: 474 Ontario
                                                    St Toronto, ON M4X 1M7 Canada
                                                </li>
                                                <li className="open">
                                                    <i className="fa fa-check" /> Opening hours
                                                    <ul>
                                                ...
                                                <li className="phone">
                                                    <i className="fa fa-phone" /> Phone: (+123)345 678 xxx
                                                </li>
                                            </ul>
                                        </div>
                                        <div className="form-vertical grid__item large--one-half">
                                            ...
                                            >
                                                ...
                                                <label htmlFor="ContactFormPhone" className="hidden-label">
                                                    Phone Number
                                                </label>
                                                <input
                                                    type="tel"
