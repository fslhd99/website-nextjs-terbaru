    ...
    <>
      ...
      <div id="PageContainer" className="is-moved-by-drawer">
        ...
        <main className="main-content">
          ...
          <div id="html-section-collection-template" className="html-section">
            <div
              ...
              <div className="wrapper">
                <div className="grid">
                  <div className="grid__item">
                    <header className="section-header text-center sticky affix animated">
                      <h1 className="text-center">
                        Your search for "Shoes" revealed the following:
                      </h1>
