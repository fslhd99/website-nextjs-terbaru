            ...
            <div id="CartSection">
              ...
              <div className="wrapper article-grid">
                <div className="grid--rev blog_list">
                  <article className="list-article grid__item large--one-third">
                    <div className="article__image">
                      <a className="article__featured-image" href="./article">
                        <img
                          src="./assets/images/blog1.png"
                          alt="These are the 5 best phones you can buy right now"
                        />
                      </a>
                    </div>
                    <h2 className="h3">
                    ...
                    <div className="article__date">
                      <span className="author">By Theme Admin</span>
                      <time dateTime="2018-05-03" className="date">
                        May 03, 2019
                      </time>
                    </div>
                    <div className="article__bottom">
                      <div className="rte rte--indented-images">
                        From high-priced pocket-busters to our favorite budget
                        beauties. You're up to date on everything you need to know
                        before buying...
                      </div>
                      <p>
                        <a href="./article" className="text-link">
                          Read More
                          <span
                  ...
                  <article className="list-article grid__item large--one-third">
                    <div className="article__image">
                      <a className="article__featured-image" href="./article">
                        <img
                          ...
                          alt="Apple's new TV app goes live with unified search"
                        />
                      </a>
                    </div>
                    <h2 className="h3">
                    ...
                    <div className="article__bottom">
                      <div className="rte rte--indented-images">
                        An update to Apple's iOS mobile software also brings
                        hundreds of new emojis to your iPhone and iPad -- and...
                      </div>
                      <p>
                        <a href="./article" className="text-link">
                          Read More
                  ...
                  <article className="list-article grid__item large--one-third">
                    <div className="article__image">
                      <a className="article__featured-image" href="./article">
                        <img
                          ...
                          alt="In 2017, your phone's camera will have superpowers"
                        />
                      </a>
                    </div>
                    <h2 className="h3">
                      <a href="./article">
                        In 2020, your phone's camera will have superpowers
                      </a>
                    </h2>
                    <div className="article__date">
                      <span className="author">By Theme Admin</span>
                    ...
                    <div className="article__bottom">
                      <div className="rte rte--indented-images">
                        Virtual reality is a somewhat understandable concept in
                        2016. You put on a headset, you find yourself in 3D
                        worlds....
                      </div>
                      <p>
                        <a href="./article" className="text-link">
